...
/* 마커 이미지 close */
		...
		daum.maps.event.addListener(map, 'click', function (mouseEvent) {
		    ...
		    //alert(latlng);
		    //window.open("mapinsert.jsp?latlng="+latlng); 
		    
//location.href = "/mapinsert/" + lat + "/" + lng;
//json ajax 통신
			 $.ajax({
				url : "/map/mapinsert/" + lat + "/" + lng + "/" + no,
				type : "post",
				async : true,
				dataType : "json",
				//data : lat/lng,
				...
				success : function(data) {
					//console.log(data);
					console.log("bb" + data.lng);
					console.log("aa" + data.lat);
		    ...
		    //latlng.value = latlng;
		    //return "mapinsert.jsp?latlng=" + latlng;
		    ...
		    /* 
				...
				var url = "mapinsert.jsp?task=idChk";
...
<form action="/map/mapinsertview" method="post" >
